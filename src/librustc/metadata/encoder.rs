...
pub struct EncodeParams<'a, 'tcx: 'a> {
    ...
    pub monomorphizations: &'a RefCell<FnvHashSet<UniversalMonoId>>
}
...
fn encode_crate_dep(rbml_w: &mut Encoder,
    ...
    rbml_w.wr_tagged_u64(tag_crate_dep_hash, dep.hash.to_u64());
    rbml_w.end_tag();
}

fn encode_hash(rbml_w: &mut Encoder, hash: &Svh) {
    rbml_w.wr_tagged_u64(tag_crate_hash, hash.to_u64());
}
...
fn encode_monomorphizations(rbml_w: &mut Encoder,
                            monomorphizations: &FnvHashSet<UniversalMonoId>) {
